...
<nav>
    <li> <div><a href="magazin.php" class="adecoration"><h5>Alegeti alt produs</h5></a></div></li>
    <li> <div><a href="logout.php" class="adecoration"><h5>Abandonati sesiunea de cumparare</h5></a></div></li>
    <li><div><a href="starecomanda.php" class="adecoration"><h5>Stare comanda</h5></a></div></li>
</nav>
